<x-layout.page-container title="Privacy Policy - Wordle Group" heading="Privacy Policy">
    <x-layout.social-meta
        title="Privacy Policy - Wordle Group"
    ...
    <div class="prose">
        ...
        <h1 class="mt-12">Interpretation and Definitions</h1>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Wordle Group.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Wordle Group, accessible from <a href="https://wordlegroup.com" rel="external nofollow noopener" target="_blank">https://wordlegroup.com</a></p>
            </li>
            <li>
                <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
            </li>
        </ul>
        <h1 class="mt-12">Collecting and Using Your Personal Data</h1>
        ...
        <h1 class="mt-12">Children's Privacy</h1>
        ...
        <h1 class="mt-12">Links to Other Websites</h1>
        <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
        <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
        <h1 class="mt-12">Changes to this Privacy Policy</h1>
        ...
        <ul>
            <li>By email: erikwestlund@hey.com</li>
        </ul>
    </div>
