<div {{ $attributes }}>
    ...
    <div class="mt-8">
        <a href="/email/WordleGroup.vcf" role="button" class="inline-flex text-sm font-semibold justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
