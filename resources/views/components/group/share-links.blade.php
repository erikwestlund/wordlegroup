    ...
    >
        <div class="flex">
            ...
            <div class="grid grid-cols-1 gap-y-4 mr-8 last:mr-0">
                <div class="flex justify-center items-center">
                    <button
                        @click="window.open('https://twitter.com/share?url={{ urlencode(route('group.home', $group)) }}&via=wordlegroup&text=View the leaderboard and stats for my Wordle Group, {{ $group->name }}.', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600')"
                        class="w-10 h-10 inline-flex items-center justify-center bg-wordle-yellow hover:bg-green-700 rounded-full text-white hover:text-green-50"
                    >
